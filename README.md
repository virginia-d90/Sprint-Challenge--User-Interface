...
semantic html gives meaning to your code. One example is that it allows for screen readers to provide better description of content.
...
git allows multiple developers to work on the same project at the same time. it also allows developers to save previous versions of their work 

5. Define mobile-first design in your own words.

mobile first design starts with designing a website for mobile and then scales up using the min-width media query to adjust.
